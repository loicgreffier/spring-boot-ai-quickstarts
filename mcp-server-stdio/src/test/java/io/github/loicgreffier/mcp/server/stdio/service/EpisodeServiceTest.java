    ...
    void shouldGetEpisodes() throws JsonProcessingException {
        when(episodeRepository.searchByTerm("Simpson"))
                .thenReturn(List.of(
                        Episode.builder()
                                .id(1L)
                                .airdate(Date.valueOf("1989-12-17"))
                                .episodeNumber(1)
